  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-8 rounded shadow-md w-80">
        <h2 className="text-2xl font-bold mb-6 text-center">Verificación de Cuenta</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Botón personalizado para la verificación */}
          <button
            type="submit"
          ...
          >
            ...
            >
              <span className="select-none">Verificar</span>
